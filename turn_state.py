...
class TurnState(State):
    ...
    def enter(self):
        ...
        self.utility_buttons[1] = Button((0,0,70), self.director.screen.get_rect().midleft[0] + 120, self.director.screen.get_rect().midleft[1] + 330, 120, 35, self.scene.wait)
    ...
    def render(self):
        ...
        self.director.screen.blit(self.font.render(self.scene.group_manager.enemy_party[0].name, True, (255, 255, 255)), (self.director.screen.get_rect().topright[0] - 220, self.director.screen.get_rect().topright[1] + 5))
        self.director.screen.blit(self.font.render(str(self.scene.group_manager.enemy_party[0].get_attribute_value(AttributeId.HP)), True, (255, 255, 255)), (self.director.screen.get_rect().topright[0] - 220, self.director.screen.get_rect().topright[1] + 30))
        self.director.screen.blit(self.font.render(str(self.scene.group_manager.enemy_party[0].counter), True, (255, 255, 255)), (self.director.screen.get_rect().topright[0] - 220, self.director.screen.get_rect().topright[1] + 55))

        self.director.screen.blit(self.font.render(self.scene.group_manager.enemy_party[1].name, True, (255, 255, 255)), (self.director.screen.get_rect().topright[0] - 220, self.director.screen.get_rect().topright[1] + 130))
        self.director.screen.blit(self.font.render(str(self.scene.group_manager.enemy_party[1].get_attribute_value(AttributeId.HP)), True, (255, 255, 255)), (self.director.screen.get_rect().topright[0] - 220, self.director.screen.get_rect().topright[1] + 155))
        self.director.screen.blit(self.font.render(str(self.scene.group_manager.enemy_party[1].counter), True, (255, 255, 255)), (self.director.screen.get_rect().topright[0] - 220, self.director.screen.get_rect().topright[1] + 180))

        self.director.screen.blit(self.font.render(self.scene.group_manager.enemy_party[2].name, True, (255, 255, 255)), (self.director.screen.get_rect().topright[0] - 220, self.director.screen.get_rect().topright[1] + 255))
        self.director.screen.blit(self.font.render(str(self.scene.group_manager.enemy_party[2].get_attribute_value(AttributeId.HP)), True, (255, 255, 255)), (self.director.screen.get_rect().topright[0] - 220, self.director.screen.get_rect().topright[1] + 280))
        self.director.screen.blit(self.font.render(str(self.scene.group_manager.enemy_party[2].counter), True, (255, 255, 255)), (self.director.screen.get_rect().topright[0] - 220, self.director.screen.get_rect().topright[1] + 305))

        self.director.screen.blit(self.font.render(self.scene.group_manager.enemy_party[3].name, True, (255, 255, 255)), (self.director.screen.get_rect().topright[0] - 220, self.director.screen.get_rect().topright[1] + 380))
        self.director.screen.blit(self.font.render(str(self.scene.group_manager.enemy_party[3].get_attribute_value(AttributeId.HP)), True, (255, 255, 255)), (self.director.screen.get_rect().topright[0]  - 220, self.director.screen.get_rect().topright[1] + 405))
        self.director.screen.blit(self.font.render(str(self.scene.group_manager.enemy_party[3].counter), True, (255, 255, 255)), (self.director.screen.get_rect().topright[0] - 220, self.director.screen.get_rect().topright[1] + 430))
